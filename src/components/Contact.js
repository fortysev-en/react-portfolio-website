			...
			<div className="flex items-center justify-center gap-10">
				...
				<form onSubmit={handleSubmit} className="w-1/3">
					...
					<button
						...
						className="text-[#999] border-2 border-[#666] px-10 py-2 rounded-2xl transition ease-in-out duration-300 hover:bg-[#f1faee] hover:text-[#212121] hover:border-[#f1faee] mt-2"
					>
						SEND
					</button>
				</form>
