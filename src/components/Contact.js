	...
	return (
		<div className="relative w-full mt-[2.5in]" ref={refs} id="contact">
			...
			<div className="flex items-center flex-col md:flex-row justify-center gap-10">
				<div className="flex gap-5 flex-wrap justify-center md:w-1/3">
				...
				<form onSubmit={handleSubmit} className="md:w-1/3">
					...
					<button
						...
						className="float-right md:float-left text-[#999] border-2 border-[#666] px-10 py-2 rounded-2xl transition ease-in-out duration-300 hover:bg-[#f1faee] hover:text-[#212121] hover:border-[#f1faee] mt-2"
					>
						SEND
					</button>
				</form>
